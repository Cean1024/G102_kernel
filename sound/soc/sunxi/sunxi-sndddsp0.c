/*
 * sound\soc\sunxi\sunxi_sndddsp0.c
...
static int sunxi_sndddsp0_hw_params(struct snd_pcm_substream *substream,
...
static struct snd_soc_ops sunxi_snddaudio_ops = {
	.hw_params	= sunxi_sndddsp0_hw_params,
};
...
static int  sunxi_sndddsp0_dev_probe(struct platform_device *pdev)
{
	int ret = 0;
...
static int  __exit sunxi_sndddsp0_dev_remove(struct platform_device *pdev)
{
...
static struct platform_driver sunxi_daudio_driver = {
	...
	.probe = sunxi_sndddsp0_dev_probe,
	.remove = __exit_p(sunxi_sndddsp0_dev_remove),
};
